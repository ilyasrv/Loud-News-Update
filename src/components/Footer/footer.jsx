    ...
    <footer className="footer wrapper">
      <div className="menufooter">
        ...
        <div className="menulogo">
          ...
          <h4 className="firstTxt">
            © 2021-2022 Loud News LLC. All Rights Reserved.{" "}
          </h4>
        </div>
      </div>
      <div className="copyright">
        <div className="TxtUp">
          <span>
            The loudest news of the crypto industry. We’ll make you hear us
          </span>
        </div>
        <div className="SocialLinks">
          ...
          <div className="Links">
            <a href="./">
              <img
                src="https://github.com/ilyasrv/Loud-News/blob/master1/assets/images/twitter.png?raw=true"
                alt={"twitter"}
              />
            </a>
            <a href="./">
              <img
                src="https://github.com/ilyasrv/Loud-News/blob/master1/assets/images/telegr.png?raw=true"
                alt={"telegram"}
              />
            </a>
            <a href="./">
              <img
                src="https://github.com/ilyasrv/Loud-News/blob/master1/assets/images/fb.png?raw=true"
                alt={"facebook"}
              />
            </a>
            <a href="./">
              <img
                src="https://github.com/ilyasrv/Loud-News/blob/master1/assets/images/inst.png?raw=true"
                alt={"instagram"}
              />
            </a>
            <a href="./">
              <img
                src="https://github.com/ilyasrv/Loud-News/blob/master1/assets/images/discord.png?raw=true"
                alt={"discord"}
              />
            </a>
            <a href="./">
              <img
                src="https://github.com/ilyasrv/Loud-News/blob/master1/assets/images/reddit.png?raw=true"
                alt={"reddit"}
              />
            </a>
          </div>
        ...
        <div className="TxtButtom">
          <a href="tel:+44581 396725">
            <span>+44 581 339 67 25</span>
          </a>
          <br />
